...
{
	partial class frmHarpaHistorico
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lblTitulo.Location = new System.Drawing.Point(219, 0);
			this.lblTitulo.Size = new System.Drawing.Size(191, 32);
			this.lblTitulo.TabIndex = 0;
			this.lblTitulo.Text = "Histórico de Hinos";
			// 
			// btnClose
			// 
			...
			this.Name = "frmHarpaHistorico";
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.Load += new System.EventHandler(this.frmHarpaHistorico_Load);
			this.Shown += new System.EventHandler(this.frmHarpaHistorico_Shown);
			this.Paint += new System.Windows.Forms.PaintEventHandler(this.frmHarpaHistorico_Paint);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmHarpaHistorico_KeyDown);
			this.Resize += new System.EventHandler(this.frmHarpaHistorico_Resize);
